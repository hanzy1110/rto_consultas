...
sudo docker-compose --env-file envfiles/.env build --no-cache --progress plain
...
sudo docker-compose --env-file envfiles/.env up -d --force-recreat --renew-anon-volumes  
