    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Div(
                ...
                Div(
                    Field("tacmarca", wrapper_class="form-group col-md-4"),
                    Field("tactipo", wrapper_class="form-group col-md-4"),
                    Field("tacmodelo", wrapper_class="form-group col-md-4"),
                    Field("tacnroserie", wrapper_class="form-group col-md-4"),
                    Field("relw", wrapper_class="form-group col-md-4"),
                    Field("constantek", wrapper_class="form-group col-md-4"),
                    Field("rodado", wrapper_class="form-group col-md-4"),
                ...
                Div(
                    ...
                    Field("desconexioncantidad", wrapper_class="form-group col-md-4"),
                    Field("desconexionhora", wrapper_class="form-group col-md-4"),
                    Field("aperturaequipo", wrapper_class="form-group col-md-4"),
                    Field(
                        "retiroelementograbacion", wrapper_class="form-group col-md-4"
                    ),
